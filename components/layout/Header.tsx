        ...
        <div className="flex items-center space-x-3">
          ...
          {isAuthenticated ? (
              ...
              {userMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white dark:bg-[--template-gray-900] border border-[--template-card-border-color] z-10">
                  <div className="px-4 py-2 text-sm text-[--template-gray-500] border-b border-[--template-card-border-color]">
                    <p className="font-medium text-[--template-gray-900] dark:text-[--template-gray-100]">
                  ...
                  <Link 
                    href="/dashboard" 
                    className="block px-4 py-2 text-sm text-[--template-gray-700] hover:bg-[--template-gray-100] dark:hover:bg-[--template-gray-800]"
                  >
                    Dashboard
                  </Link>
                  <Link 
                  ...
                  <button 
                    onClick={signOut}
                    className="w-full text-left block px-4 py-2 text-sm text-[--template-gray-700] hover:bg-[--template-gray-100] dark:hover:bg-[--template-gray-800] border-t border-[--template-card-border-color]"
                  >
            ...
            <Button 
              ...
              className="bg-[--template-primary] hover:bg-[--template-primary-hover] text-white"
            >
              Sign In
            </Button>
          )}
